...
const ContactPage = () => {
  return (
    <div className="w-full h-[85vh]">
      <div className="w-full grid grid-cols-2 bg-slate-100 px-4">
        <iframe
        ...
        <div className="w-full h-full py-10 px-10">
          ...
          <div className="grid grid-cols-2 mt-5">
            <div className="flex flex-col space-y-2">
              ...
              <input
                type="text"
                className="border-none focus:border-none focus:ring-0 rounded-md"
              />
            </div>
          </div>
        </div>
      </div>
      <div className="flex  items-center h-28 justify-between max-w-7xl mx-auto">
